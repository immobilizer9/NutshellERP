    ...
    <>
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 20, flexWrap: "wrap" }}>
        <button
          ...
          className="btn"
          style={{
            background: filter === "" ? "var(--accent)" : undefined,
            color: filter === "" ? "#fff" : undefined,
          }}
        >
          All
        </button>
        {distinctActions.map((a) => (
          <button
            ...
            style={{
              fontSize: 12,
              background: filter === a ? "var(--accent)" : undefined,
              color: filter === a ? "#fff" : undefined,
            }}
          >
            {a.replaceAll("_", " ")}
          </button>
            ...
            {pages > 1 && (
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 16, fontSize: 13 }}>
                ...
                <div style={{ display: "flex", gap: 6 }}>
                  <button className="btn" disabled={page === 1} onClick={() => handlePage(page - 1)} style={{ fontSize: 12 }}>
                    ← Prev
                  </button>
                  <button className="btn" disabled={page === pages} onClick={() => handlePage(page + 1)} style={{ fontSize: 12 }}>
                    Next →
                  </button>
                </div>
              </div>
